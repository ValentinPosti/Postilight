...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Views.MvxTabsFragmentActivity+TabFactory, MvvmCross", MvxTabsFragmentActivity_TabFactory.class, __md_methods);
	}
	...
	public MvxTabsFragmentActivity_TabFactory ()
	{
		...
		if (getClass () == MvxTabsFragmentActivity_TabFactory.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Views.MvxTabsFragmentActivity+TabFactory, MvvmCross", "", this, new java.lang.Object[] {  });
	}
	...
	public MvxTabsFragmentActivity_TabFactory (android.content.Context p0)
	{
		super ();
		if (getClass () == MvxTabsFragmentActivity_TabFactory.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Views.MvxTabsFragmentActivity+TabFactory, MvvmCross", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
